...
parser.add_argument("--use_model", nargs="+", type=str, default=["OpenAI-ViT-L/14", 'CLIPneedsREGISTERS/REG-XGATED/ft-checkpoints/clip_ft_12_backtoweight.safetensors'], help="Primary model name. Usage: --model_name OpenAI-ViT-L/14 path/to/custom_model.pt (.safetensors)")
