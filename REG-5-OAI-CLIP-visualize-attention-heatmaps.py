...
import ATTNclipORG as clip
from ATTNclipORG.simple_tokenizer import SimpleTokenizer as _Tokenizer
...
def parse_arguments():
    ...
    parser.add_argument('--use_model', 
                        default="ViT-L/14", 
                        help="Name or path to a ViT-L/14 model, pickle (.pt) or .safetensors")
...
heatmap_folder = "plots/OAI-CLIP/attn-heatmap"
