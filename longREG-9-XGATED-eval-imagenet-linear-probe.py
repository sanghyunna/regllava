...
print("Running Linear Probe on ImageNet for fine-tuned Long-REG-CLIP gated model...")
...
print("Extracting Long-REG-CLIP image embeddings...")
...
print(f"\nGATED Long-REG-CLIP fine-tune, Linear Probe Results: Top-1: {top1_acc:.2f}% | Top-5: {top5_acc:.2f}%")

with open(f"{local_path}/linear-probe.txt", "a", encoding='utf-8') as f:
    f.write(f"GATED Long-REG-CLIP fine-tune, Linear Probe Results: Top-1: {top1_acc:.2f}% | Top-5: {top5_acc:.2f}%")