...
print(f"GATED REG-CLIP fine-tune, Accuracy on MVT ImageNet/ObjectNet: {model_accuracy:.4f}")

local_path = "plots/REG-XGATED/imagenet"
os.makedirs(local_path, exist_ok=True)
with open(f"{local_path}/imagenet-objectnet.txt", "w", encoding='utf-8') as f:
    f.write(f"XGATED REG-CLIP fine-tune, Accuracy on MVT ImageNet/ObjectNet: {model_accuracy:.4f}")
