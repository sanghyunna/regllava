...
from longmodel.model_longclip import QuickGELU
import open_clip
import numpy as np
import torch
...
parser.add_argument('--use_model', default=["OpenAI-models/LongCLIP-L.safetensors", "models/LongCLIP-L.safetensors"], help="Path to a ViT-L/14 model, pickle (.pt) or .safetensors")
...
def manu_clip_encode_text(model, text, last=-1):
    global print_once_t
    global last_txt
    n_ctx = text.shape[-1]
