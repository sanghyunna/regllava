...
import TRAINgmpCLIPregXGATED as clip
...
plots_folder = 'CLIPneedsREGISTERS/REG-XGATED/ft-plots'
os.makedirs(plots_folder, exist_ok=True)

# Save model .pt files to: 
ft_checkpoints_folder = 'CLIPneedsREGISTERS/REG-XGATED/ft-checkpoints'
os.makedirs(ft_checkpoints_folder, exist_ok=True)

# Save verbose text / training logs to:
text_logs_folder = 'CLIPneedsREGISTERS/REG-XGATED/ft-logs'
...
print("== START == \n")
print(f"Checking on the register tokens... If init correctly, there should be tensor:\n{model.visual.register_tokens}")
