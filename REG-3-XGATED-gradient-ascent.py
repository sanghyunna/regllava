...
def parse_arguments():
    ...
    parser.add_argument('--use_model', default="CLIPneedsREGISTERS/REG-XGATED/ft-checkpoints/clip_ft_20_backtoweight.safetensors", help="Path to a ViT-L/14 model, pickle (.pt) or .safetensors")
