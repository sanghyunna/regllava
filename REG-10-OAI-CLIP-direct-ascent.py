...
parser.add_argument("--use_model", nargs="+", type=str, default=["OpenAI-ViT-B/32", None], help="Primary model name. Usage: --model_name 'OpenAI-ViT-B/32' ...OR: --model_name 'OpenAI-ViT-B/32' 'path/to/custom_model.pt'")
