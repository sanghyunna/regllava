...
local_path ="plots/Long-CLIP/imagenet"
...
print("Running Linear Probe on ImageNet for Long-CLIP model...")
...
print("Extracting Long-CLIP image embeddings...")
...
print(f"\nLong-CLIP, Linear Probe Results: Top-1: {top1_acc:.2f}% | Top-5: {top5_acc:.2f}%")

with open(f"{local_path}/linear-probe.txt", "a", encoding='utf-8') as f:
    f.write(f"Long-CLIP, Linear Probe Results: Top-1: {top1_acc:.2f}% | Top-5: {top5_acc:.2f}%")
