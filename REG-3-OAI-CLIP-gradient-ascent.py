...
def parse_arguments():
    ...
    parser.add_argument('--use_model', default="ViT-L/14", help="Name or path to a ViT-L/14 model, pickle (.pt) or .safetensors. Default: ViT-L/14")
...
def main():
    ...
    if model_name_or_path.endswith(".safetensors"):
        ...
        print("Detected non-.safetensors file or model name. Attempting to load model...")
