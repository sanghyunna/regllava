...
def parse_arguments():
    ...
    parser.add_argument('--use_model', default="models/Long-ViT-L-14-REG-GATED-full-model.safetensors", help="Path to a LongCLIP ViT-L/14 model, pickle (.pt) or .safetensors")
