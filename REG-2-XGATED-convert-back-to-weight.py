...
import INFERclipregXGATED.model
from INFERclipregXGATED.model import CLIP

which_finetune_number = "20" # 20 for e.g. clip_ft_20.pt
...
model_path = f"CLIPneedsREGISTERS/REG-XGATED/ft-checkpoints/clip_ft_{which_finetune_number}.pt"
...
torch.save(original_state_dict, f"CLIPneedsREGISTERS/REG-XGATED/ft-checkpoints/clip_ft_{which_finetune_number}_state_dict.pt")

print(f"\n--------> Model state_dict successfully converted and saved as 'clip_ft_{which_finetune_number}_state_dict.pt'")

# Load state_dict (converted version)
state_dict_path = f"CLIPneedsREGISTERS/REG-XGATED/ft-checkpoints/clip_ft_{which_finetune_number}_state_dict.pt"
...
torch.save(model, f"CLIPneedsREGISTERS/REG-XGATED/ft-checkpoints/clip_ft_{which_finetune_number}_backtoweight.pt")

print(f"--------> Full pickled model saved as 'clip_ft_{which_finetune_number}_backtoweight.pt'")
...
#torch.save(ablated_model_REG, f"CLIPneedsREGISTERS/REG-XGATED/ft-checkpoints/clip_ft_{which_finetune_number}_backtoweight_ablated_REG.pt")
#print(f"--------> Full pickled ablated REG model saved as 'clip_ft_{which_finetune_number}_backtoweight_ablated_REG.pt'")
...
torch.save(ablated_model_ALL, f"CLIPneedsREGISTERS/REG-XGATED/ft-checkpoints/clip_ft_{which_finetune_number}_backtoweight_ablated.pt")
print(f"--------> Full pickled ablated ALL model saved as 'clip_ft_{which_finetune_number}_backtoweight_ablated.pt'")
