...
import longINFERclipregXGATED as fortokenizer
...
def parse_arguments():
    ...
    parser.add_argument('--use_model', default="models/LongCLIP-L.safetensors", help="Name or path to a ViT-L/14 model, pickle (.pt) or .safetensors. Default: ViT-L/14")
    ...
    if args.use_best:
        ...
        for j in range(training_iterations):
            ...
            if not args.no_adjust:
                ...
                if j == 150:
                    val_coarse = 10000 # edit these for dynamic softmax
                ...
                if j == 300:
                    ...
                    val_mid=10000 # edit these for dynamic softmax
                    val_fine=1000 # edit these for dynamic softmax
...
def main():
    ...
    tok = fortokenizer.simple_tokenizer.SimpleTokenizer()
