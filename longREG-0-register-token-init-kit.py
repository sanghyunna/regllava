...
model, preprocess = clip.load("models/LongCLIP-L.safetensors", device=device)
model = model.float()
...
# Interestingly, in Long-CLIP, the norms were lower (but still outliers!):
# L2 Norm Statistics of Top Register Tokens:
# Top-1 Register Token - Mean: 205.09, Max: 236.17, Min: 118.11
# Top-2 Register Token - Mean: 143.94, Max: 204.35, Min: 90.01
# Top-3 Register Token - Mean: 119.50, Max: 179.22, Min: 90.01
# Top-4 Register Token - Mean: 107.52, Max: 167.80, Min: 90.11

save_dir = "longregtokens"
