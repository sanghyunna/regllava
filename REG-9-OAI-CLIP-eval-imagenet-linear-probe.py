...
local_path ="plots/OAI-CLIP/imagenet"
...
print(f"\nORIGINAL OpenAI CLIP pre-trained, Linear Probe Results: Top-1: {top1_acc:.2f}% | Top-5: {top5_acc:.2f}%")

with open(f"{local_path}/linear-probe.txt", "a", encoding='utf-8') as f:
    f.write(f"ORIGINAL OpenAI CLIP pre-trained, Linear Probe Results: Top-1: {top1_acc:.2f}% | Top-5: {top5_acc:.2f}%")
